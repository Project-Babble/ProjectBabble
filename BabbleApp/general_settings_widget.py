            ...
            if self.config.gui_osc_port != int(values[self.gui_osc_port]):
                try:
                    ...
                    if len(values[self.gui_osc_port]) <= 5:
                        ...
                        print(f'\033[91m[{lang._instance.get_string("log.error")}] {lang._instance.get_string("general.oscPort")}\033[0m')
                except:
                    print(f'\033[91m[{lang._instance.get_string("log.error")}] {lang._instance.get_string("general.oscPort")}\033[0m')
        except:
            print(f'\033[91m[{lang._instance.get_string("log.error")}] {lang._instance.get_string("general.oscValue")}\033[0m')
